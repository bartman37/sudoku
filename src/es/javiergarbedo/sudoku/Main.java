...
public class Main extends javax.swing.JFrame {
     ...
     */
    public Main() {
        //Seleccionamos por defecto el idioma del ordenador en uso.
        Locale.getDefault();
        myBundle = ResourceBundle.getBundle("lang/strings");
        initComponents();
        ...
        levelSelected = jComboBox1.getSelectedIndex();
    ...
    private void setLevel(int level) {
        ...
        if(level < TOP_LEVEL) {
           ...
           RandomAccessFile raf;
            try{        
              raf = new RandomAccessFile("sudoku_levels.txt","r");
              int numNivel = (int)(raf.length() / tam_linea);
              long posNivelInFile = level * tam_linea;
              if(posNivelInFile < raf.length() && posNivelInFile >= 0){
                  raf.seek(posNivelInFile);
                  strLevel = raf.readLine();
    ...
    private void initComponents() {
        ...
        jLabel1Level = new javax.swing.JLabel();
        ...
        jLabel1Level.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1Level.setText("Nivel:");
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        Properties properties = new Properties();
        String ultimoNivel= String.valueOf(jComboBox1.getSelectedIndex());
        
        
            try {
                properties.load(new BufferedReader(new FileReader("sudoku.properties")));
                
                properties.setProperty("last_level", ultimoNivel);
            try {
            //Crea el archivo de propiedades
            properties.store(new BufferedWriter(new FileWriter("sudoku.properties")),"último Nivel");
        } catch (IOException ex) {
    ...
    private javax.swing.JLabel jLabel1Level;
